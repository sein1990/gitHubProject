...
String empIDS="";
 ...
 String dbID="";
    ...
    ResultSet rs=null;
    String IDquery=objQuery.a3(caseid1);
    ...
    IDquery=objQuery.a3Attachment(caseid1);
    ps=con1.prepareStatement(IDquery);
    rs=ps.executeQuery(); 
...
<div class="col-xs-12">
        ...
        <form class="form-horizontal"  action="A3Servlet" method="post" enctype="multipart/form-data" >
...
<p><p>
                            ...
                            for(int i=0;i<attachVector.size();i++){                               
                                ...
                                out.print("<input type='hidden' name='deleteattachmentpageid' id='deleteattachmentpageid' value='3'>");   
