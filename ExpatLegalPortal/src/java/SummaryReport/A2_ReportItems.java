 ...
 * @author USER
 */
public class A2_ReportItems {
    String caseID,date, reason, name, unity, remarks, recovered, salaryDeposit, totalAmount, fileClosed, empID;

    public A2_ReportItems(String caseID, String date, String reason, String name, String unity, String remarks, String recovered, String salaryDeposit, String totalAmount, String fileClosed, String empID) {
        this.caseID = caseID;
        this.date = date;
        this.reason = reason;
        this.name = name;
