...
String empIDS="";
 ...
 String dbID="";
    ...
    ResultSet rs=null;
    String IDquery="SELECT * FROM `leave_extension` WHERE `id`='"+caseid1+"'";
...
<div class="col-xs-12">
        ...
        <form class="form-horizontal"  action="LeaveExtension" method="post" enctype="multipart/form-data" >
                <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" name="caseidupdate"  class="form-control" required="required" value="<%=caseid1%>"/>
                        </div>
                </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                                <input type="date" name="date" value="<%=dateS%>" class="form-control"  required/>
                        </div>
                </div>
                                        <div class="form-group">
                        ...
                        <div class="col-sm-9">
                                <input type="text" name="name" value="<%=nameS%>" class="form-control"  required/>
                        </div>
                </div>
                 ...
                 <div class="form-group">
                        ...
                        <div class="col-sm-9">
                                <input type="date" name="from" value="<%=fromS%>" class="form-control"  required/>
                        </div>
                </div>
                <div class="form-group">
                        <label class="col-sm-3 control-label no-padding-right" for="form-field-1-1"> To</label>

                        <div class="col-sm-9">
                                <input type="date" name="to" value="<%=toS%>"class="form-control" required/>
                        </div>
                </div>
            <div class="form-group">
                        ...
                        <div class="col-sm-9">
                                <input type="text" name="extendedDay" value="<%=extendedDayS%>" class="form-control"  required/>
                                                      ...
                                                      <div class="form-group">
                        <label class="col-sm-3 control-label no-padding-right" for="form-field-1-1">Actual</label>

                        <div class="col-sm-9">
                                <input type="date" name="actual" value="<%=actualS%>" class="form-control"  required/>
                        </div>
                        </div>
                                              <div class="form-group">
