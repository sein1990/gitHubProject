...
//String UPLOAD_DIRECTORY ="C://Users//Sein 90//Desktop//up";
    ...
    ResultSet rs=null;
    String IDquery="SELECT * FROM `terminated_emp_due_loss_or_performance` WHERE `id`='"+caseid1+"'";
...
<div class="col-xs-12">
        ...
        <form class="form-horizontal"  action="TerminatedEmp" method="post" enctype="multipart/form-data" >
              ...
              <div class="form-group">
                        ...
                        <div class="col-sm-9">
                                <input type="text" name="details" value="<%=detailsS%>" class="form-control"  required/>
