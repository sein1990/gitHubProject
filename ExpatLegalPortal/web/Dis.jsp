...
String empIDS="";
 ...
 String dbID="";
    ...
    ResultSet rs=null;
    String IDquery="SELECT * FROM `dis` WHERE `id`='"+caseid1+"'";
...
<div class="col-xs-12">
        ...
        <form class="form-horizontal"  action="DisServlet" method="post" enctype="multipart/form-data" >
                ...
                <div class="form-group">
                        <label class="col-sm-3 control-label no-padding-right" for="form-field-1-1"> Investigation</label>

                        <div class="col-sm-9">
                                <input type="text" name="investigation" value="<%=investigationS%>"class="form-control" required/>
            ...
            <div class="form-group">
                        ...
                        <div class="col-sm-9">
                                <input type="text" name="peopleInvolved" value="<%=peopleInvolvedS%>" class="form-control"  required/>
