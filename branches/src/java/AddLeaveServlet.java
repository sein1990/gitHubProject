 ...
 * @author user
 */
@WebServlet(urlPatterns = {"/AddLeaveServlet"})
public class AddLeaveServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet AddLeaveServlet</title>");            
            out.println("</head>");
            out.println("<body>");
...
//
//          
            String fromdate = request.getParameter("branchname");
            out.println("<title>"+fromdate+"</title>");            
...
//            Logger.getLogger(AddLeaveServlet.class.getName()).log(Level.SEVERE, null, ex);
//        } 
    }
