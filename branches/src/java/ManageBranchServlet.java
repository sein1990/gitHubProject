 ...
 * @author user
 */
@WebServlet(urlPatterns = {"/ManageBranchServlet"})
public class ManageBranchServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String[] openedNumbers =  request.getParameterValues("opennumbers");
            
            for(int i=0;i<branchIds.length;i++){
                Branch b = new Branch(branchIds[i], Integer.parseInt(openedNumbers[i]));
                b.UpdateBranch();
            }   
            ...
            String JSPFile = "/branchespage.jsp?buttonid=0";
